...
// Payload ,parte JWT contenente l'id
export const generateJWT = (payload) => {
    ...
    jwt.sign( 
        ...
        process.env.JWT_SECRET, // La chiave segreta usata per firmare il token, memorizzata nelle variabili d'ambiente(Header)
        { expiresIn: "1 day" }, // Opzioni: imposta la scadenza del token a 1 giorno, se si mette un numero sono secondi
        (err, token) => {
